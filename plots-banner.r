...
prodplot(happy, ~ marital + happy, c("hbar", "vbar"), na.rm = TRUE, levels = NA) + fill_marital + no_axes
ggsave("plots/banner-3.pdf", width = 4, height = 4)

prodplot(happy, ~ marital + happy, c("hbar", "hspine"), na.rm = TRUE, levels = NA) + fill_marital + no_axes
ggsave("plots/banner-4.pdf", width = 4, height = 4)

prodplot(happy, ~ marital + happy, c("hspine", "vbar"), na.rm = TRUE, levels = NA) + fill_marital + no_axes
