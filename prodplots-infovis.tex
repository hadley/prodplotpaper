...
\multicolumn{3}{l}{$f(happy, sex)$, see fig. \ref{fig:fact-simple} (right) }\\
  ...
  \begin{tabular*}{0.49\linewidth}{rrr}
\multicolumn{3}{l}{$f(sex|happy)$, see fig. \ref{fig:fact-simple} (middle) }\\
  \toprule
  & male & female \\
  \midrule
...
%
\hspace{1em}
  \begin{tabular*}{0.47\linewidth}{rrr}
\multicolumn{3}{l}{$f(happy| sex)$}\\
  ...
  \begin{tabular}{rrrr}
\multicolumn{3}{l}{$f(happy)$, see fig. \ref{fig:fact-simple} (left) and $f(sex)$}\\
  \toprule
  & male & female & \\ 
  \midrule
  not too happy & & & 0.12 \\ 
