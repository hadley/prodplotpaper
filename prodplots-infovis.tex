...
\begin{figure}[htbp]
  ...
  \caption{(Left) The joint distribution of marital status and age, $f(marital, age)$, (in decades) partitioned by a vspine and hspine.  (Right) The joint distribution of age and marital status, $f(age, marital)$, partitioned by a vspine and hbar.}
  \label{fig:marital}
\end{figure}
